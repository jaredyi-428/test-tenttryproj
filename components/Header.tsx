    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <button onClick={() => onNavigate(Page.HOME)} className="text-sm font-medium text-gray-600 hover:text-brand-600 transition-colors">首頁</button>
          <button onClick={() => onNavigate(Page.CATALOG)} className="text-sm font-medium text-gray-600 hover:text-brand-600 transition-colors">裝備目錄</button>
          <button className="text-sm font-medium text-gray-600 hover:text-brand-600 transition-colors">露營指南</button>
          <button className="text-sm font-medium text-gray-600 hover:text-brand-600 transition-colors">關於我們</button>
        </nav>
